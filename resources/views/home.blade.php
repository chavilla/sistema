...
<div class="container">
    <div class="row mt-3 justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-brown text-white">Dashboard</div>
    ...
    <section class="content mt-5 mb-3 pt-2">
        <h2 class="text-center display-4 my-3 mb-5">Productos no disponibles</h2>
    ...
    <section class="information content text-center mt-5 pt-5">
        <h2 class="text-center  display-4 mb-5">Estadísticas</h2>
        <div class="row mb-3 w-100  mx-auto">
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card  text-white mx-auto sales bg-primary mb-3" style="max-width: 18rem;">
            ...
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card  text-white mx-auto sales bg-info mb-3" style="max-width: 18rem;">
                    <div class="card-header"><h2>Ventas de este mes</h2></div>
                    <div class="card-body">
                        <p class=" text-center sales-txt">${{ $salesThisMonth}}</p>
                    </div>
                </div>
            </div>
           
            <div class="col-12  col-md-6 col-lg-4 my-3">
                <div class="card products text-white bg-danger mb-3 mx-auto" style="max-width: 18rem;">
            ...
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card clients text-white bg-success mb-3 mx-auto" style="max-width: 18rem;">
            ...
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card categories text-white bg-purple mb-3 mx-auto" style="max-width: 18rem;">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-3">
                <div class="card users text-white bg-orange mb-3 mx-auto" style="max-width: 18rem;">
