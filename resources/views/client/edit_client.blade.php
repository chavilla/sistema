        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-center text-white">Editar cliente</h1>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{action('ClientController@update')}}">
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nit:') }}</label>
                            <div class="col-md-6">
                                <input id="nit" type="text" class="form-control @error('nit') is-invalid @enderror" name="nit" value="{{ $client->nit ?? '' }}" required autocomplete="nit" autofocus>
                                @error('nit')
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Teléfono:') }}</label>
                            <div class="col-md-6">
